...
public class ProductDAOImpl implements ProductDAO {
	...
	public PaginationResult<ProductInfo> getAllProductInfos(int page, int maxResult, String likeName) {
		...
		PaginationResult<ProductInfo> paginationResult = new PaginationResult<ProductInfo>(query, page, maxResult);//gọi đến Constructor có 3 tham số của PaginationResult
